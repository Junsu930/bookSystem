...
public class BookService {
	...
	public void bookList() {
		...
		Collections.sort(library,new UserComparator());
	...
	public String editBook() {
		...
		do {
			...
			for(Book temp : library) {
				if(libraryNum == temp.getBookNum()){ //temp의 인덱스 번호 +1이 등록번호이다.
